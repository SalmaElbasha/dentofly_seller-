  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<ChatController>(
        builder: (context, chatProvider,child) {
          ...
          bool showMessageText = message.message != null && message.message!.isNotEmpty;
          if(images.isNotEmpty && files.isEmpty) {
            if(RegExp(r'\.(jpg|jpeg|png|gif|webp)$', caseSensitive: false).hasMatch(message.message??'')) {
