...
class AuthRepository implements AuthRepositoryInterface{
  ...
  Future<ApiResponse> registration(
    ...
    // Add governorate_ids like in Postman screenshot
    for (int i = 0; i < (registerModel.governorateIds?.length??0); i++) {
      request.fields['governorate_ids[$i]'] = registerModel.governorateIds![i].toString();
    }
