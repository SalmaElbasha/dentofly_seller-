...
class ProfileRepository implements ProfileRepositoryInterface{
  ...
  Future<http.StreamedResponse> updateProfile(
      ProfileInfoModel userInfoModel,
      ProfileBody seller,
      File? file,
      String token,
      String password,
      List<int> selectedGovernoratesIds, // ← استلام المحافظات
      ) async {
    ...
    // المحافظات بالشكل المطلوب
    for (int i = 0; i < selectedGovernoratesIds.length; i++) {
      fields['governorate_ids[$i]'] = selectedGovernoratesIds[i].toString();
    }
