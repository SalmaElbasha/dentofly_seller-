...
abstract class ProfileRepositoryInterface implements RepositoryInterface{
  ...
  Future<http.StreamedResponse> updateProfile(ProfileInfoModel userInfoModel, ProfileBody seller,  File? file, String token, String password,List<int>selectedGovernoratesIds);
