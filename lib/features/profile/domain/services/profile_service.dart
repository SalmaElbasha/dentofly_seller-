...
class ProfileService implements ProfileServiceInterface{
  ...
  @override
  Future updateProfile(ProfileInfoModel userInfoModel, ProfileBody seller, File? file, String token, String password,List<int> SelectedGovernoratesIds) {
    return profileRepoInterface.updateProfile(userInfoModel, seller, file, token, password,SelectedGovernoratesIds);
  }
